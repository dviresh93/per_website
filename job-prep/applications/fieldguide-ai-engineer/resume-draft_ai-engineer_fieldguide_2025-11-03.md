# Resume Draft - Fieldguide AI Engineer
...
**Other:**
- ✅ Summary customized for Fieldguide (LangChain, RAG, agentic systems, document understanding, Anthropic/OpenAI)
- ✅ Skills reordered (AI/ML Frameworks first - LangChain, RAG, Agentic AI leading)
- ✅ Education unchanged
- ✅ No `label` field
...
### Customized for Fieldguide:
- [ ] **Summary:** Emphasizes LangGraph, LangChain, RAG, agentic systems, document understanding, Anthropic/OpenAI, evaluation frameworks
- [ ] **Skills:** AI/ML Frameworks first (LangGraph, LangChain, RAG, Agentic AI leading)
- [ ] **GridCOP:** LangGraph orchestration, RAG pipelines, evaluation frameworks - PERFECT match
- [ ] **Freefly bullet 1:** Document processing (logs), LLM integration, evaluation
- [ ] **Production Tool project:** Document understanding (log processing)
...
3. Generate PDF with MCP tool using naming convention: `vireshduvvuri_ai-engineer_fieldguide_2025-11-03.pdf`
4. Generate directly to folder via symlink: `folderPath: "per_wesite_job_prep/fieldguide-ai-engineer"`
