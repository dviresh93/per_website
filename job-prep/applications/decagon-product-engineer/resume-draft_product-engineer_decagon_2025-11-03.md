# Resume Draft - Decagon Product Engineer

**FOR REVIEW BEFORE PDF GENERATION**
...
**Work Experience:**
- ✅ Grid CoOperator: 3 bullets (all customized for Product Engineer role)
- ✅ Freefly: 4 bullets (bullet 1 customized for Product Engineer, bullets 2-4 LOCKED)
- ✅ Lumenier: 2 bullets (LOCKED - verified exact match)
- ✅ York: 2 bullets (LOCKED - verified exact match)

**Dates:**
- ✅ Grid CoOperator: Mar 2025 - Present
- ✅ Freefly: Nov 2021 - Oct 2025
- ✅ Lumenier: Jul 2020 - Oct 2021
- ✅ York: Aug 2018 - May 2020
...
**Other:**
- ✅ Summary customized for Product Engineer + TypeScript/Python + AI agent platforms + unstructured data
- ✅ Skills reordered (Programming first, then AI/ML)
- ✅ Education unchanged
- ✅ No `label` field
...
Product Engineer with 5+ years building production AI platforms using TypeScript/React and Python. Proven track record developing full-stack AI agent systems from concept to production, serving 200+ daily users with end-to-end ownership of monitoring, automation, and unstructured data extraction. Strong expertise in async programming, system debugging, and rapid iteration - delivering 70-80% efficiency improvements through intelligent automation that scales to millions of interactions.
...
**AI/ML Frameworks:**
LangGraph, LangChain, Multi-Agent Systems, Agentic AI, RAG, Model Evaluation, MLOps, Observability, MCP (Model Context Protocol), Prompt Engineering, Context Engineering, GenAI, FAISS, Pinecone, PyTorch, TensorFlow, Scikit-learn, Feature Engineering, Human-in-the-Loop (HIL), Model Deployment, Vector Search

**Programming:**
Python, TypeScript, JavaScript, SQL, FastAPI, Flask, React, C++, NumPy, Pandas, OOP

**Cloud & Infrastructure:**
AWS, Azure, Production Deployment, CI/CD Pipelines, Monitoring, API Design, DevOps, Docker, Kubernetes, Performance Tuning, Scalability, Observability

**Product & Collaboration:**
Cross-functional Leadership, Rapid Prototyping, Consumer AI Products, Architectural Design, Mentorship, Agile Development, Technical Communication
...
*Senior Software Engineer, Nov 2021 - Oct 2025*
...
*Drone Software Developer, Jul 2020 - Oct 2021*
...
*Software Engineer - R&D, Aug 2018 - May 2020*
...
*Master of Science in Computer Science, Jan 2015 - Jan 2017*

### **GITAM University** (Visakhapatnam, India)
*Bachelor of Technology in Information Technology, Jan 2011 - Jan 2015*
...
Please verify the following before I generate the PDF:

### LOCKED Sections (Must Match Exactly):
- [ ] **Lumenier bullets:** LiDAR/optical flow + open-source maintainers ✓
- [ ] **York bullets:** ROS2/SLAM + HMI/Kivy ✓
- [ ] **Freefly bullets 2-4:** Flight control + release management + automated systems ✓

### Customized for Decagon:
- [ ] **Summary:** Emphasizes TypeScript/React + Python, AI agent platforms, unstructured data, monitoring/automation, end-to-end ownership
- [ ] **Skills:** Programming first (Python, TypeScript leading), then AI/ML frameworks
- [ ] **Freefly bullet 1:** GenAI agent (200+ users) - shows production AI tool experience
- [ ] **Production Tool project:** TypeScript/React + Python + unstructured data extraction - PERFECT match
- [ ] **GridCOP:** AI agent orchestration, monitoring, rapid deployment

### Quality Checks:
- [ ] All dates correct
- [ ] No typos
- [ ] Projects in Problem/Solution/Impact format
- [ ] No placeholder text
...
If approved, I will:
1. Convert this markdown to JSON
2. Run final validation
3. Generate PDF with MCP tool using naming convention: `vireshduvvuri_product-engineer_decagon_2025-11-03.pdf`
4. Generate directly to folder via symlink: `folderPath: "per_wesite_job_prep/decagon-product-engineer"`
5. Extract and verify PDF text
