# Resume Draft - Paradigm Applied AI Engineer
...
**Work Experience:**
- ✅ Grid CoOperator: 3 bullets (all customized for Applied AI Engineer role)
- ✅ Freefly: 4 bullets (bullet 1 customized for AI Engineer, bullets 2-4 LOCKED)
...
**Other:**
- ✅ Summary customized for Applied AI + domain adaptation + construction workflows
- ✅ Skills reordered (AI/ML Frameworks first, LangGraph/LangChain leading)
- ✅ Education unchanged
- ✅ No `label` field
...
Applied AI Engineer with 5+ years building production agentic systems using LangGraph, LangChain, and RAG pipelines for complex workflows. Proven track record deploying multimodal AI at scale with evaluation frameworks, cost optimization, and observability - delivering 70-80% efficiency gains within 3 months. Successfully transitioned from robotics to AI domains, demonstrating rapid learning ability and technical depth to solve industry-specific challenges with cutting-edge AI orchestration.
...
### Customized for Paradigm:
- [ ] **Summary:** Emphasizes LangGraph/RAG, domain adaptation (robotics→AI), construction workflow readiness
- [ ] **Skills:** AI/ML Frameworks first, LangGraph/LangChain/RAG leading
- [ ] **GridCOP:** All 3 bullets highlight LangGraph orchestration, evaluation, production deployment
- [ ] **Freefly bullet 1:** GenAI-powered agent emphasis (Applied AI Engineer version)
- [ ] **Projects:** All 3 demonstrate agentic AI + RAG + production deployment
...
3. Generate PDF with MCP tool using naming convention: `vireshduvvuri_applied-ai-engineer_paradigm_2025-11-03.pdf`
4. Generate directly to folder via symlink: `folderPath: "per_wesite_job_prep/paradigm-applied-ai-engineer"`
